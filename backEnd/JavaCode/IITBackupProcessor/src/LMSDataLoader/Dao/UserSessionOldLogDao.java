...
public class UserSessionOldLogDao {
	private static PreparedStatement ps = null;
	private Connection conn = null;
	private static String sqlStmt = null;
	public UserSessionOldLogDao(Connection conn){
				try{
			sqlStmt = "insert into UserSessionOldLog (sessionSysName, lmsName, orgName, courseName,courseRun, lmsUserId, userName," + 
	...
	public Boolean insertRec(UserSessionOldLog userSession) throws IOException {
