...
class MysqlInsertTaskMixin(OverwriteOutputMixin):
    ...
    """
    database = luigi.Parameter(config_path={'section': 'database-export', 'name': 'database'})
    credentials = luigi.Parameter(config_path={'section': 'database-export', 'name': 'credentials'})
