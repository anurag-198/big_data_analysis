...
class ImportUserProfileTask(ImportMysqlToHiveTableTask):

    """Imports user information from an external LMS DB to a destination directory joining 
       AuthUser and AuthUserProfile (done by the Extraction Transform and Load Task)"""
    ...
    @property
    def columns(self):
        # Fields not included are 'password'!
        return [
		('userId', 'BIGINT'),
		('lmsUserId', 'BIGINT'),
		('lmsName', 'STRING'),
		...
		('emailId', 'STRING'),
		('mothertounge', 'STRING'),
		('highestEduDegree' ,'STRING'),
		('goals', 'STRING'),
		('city', 'STRING'),
		('state', 'STRING'),
		('active', 'INT'),
		('firstAccesDate', 'TIMESTAMP'),
...
class ImportLogDataTask(ImportMysqlToHiveTableTask):
    """Imports user cohort information from an external LMS DB to a destination directory."""
    ...
    def columns(self):
		...
		('dataSource', 'STRING' ) ,
		('oldVideoSpeed', 'FLOAT') ,
		('currVideoSpeed', 'FLOAT') ,
		('oldVideoTime', 'FLOAT') ,
		('currVideoTime', 'FLOAT') ,
		('videoNavigType', 'STRING' ) ,
		('oldGrade', 'FLOAT' ),
		('currGrade', 'FLOAT') ,
		('maxGrade', 'FLOAT') ,
		('attempts', 'INT' ),
		...
		('currPosition', 'INT') ,
		('oldPosition', 'INT') ,
		('chapterSysName', 'STRING')  ,
		('chapterTitle', 'STRING')  ,
		('sessSysName', 'STRING')  ,
		('sessTitle', 'STRING')  ,
		('moduleSysName', 'STRING')  ,
		('moduleTitle', 'STRING')  ,
		('answerChoice', 'STRING') ,
		('success', 'STRING')  ,
		('done', 'STRING')  ,
		('enrolmentMode', 'STRING')  ,
		('totDurationInSecs', 'INT') ,
		('eventNo', 'SMALLINT') ,
		('otherTitle', 'STRING')  ,
		('otherType', 'STRING')  ,
		('anonymous', 'STRING')  ,
		('anonymousToPeers', 'STRING')  ,
		('eduLevel', 'STRING')  ,
		('gender', 'STRING')  ,
		...
		('commentSysId', 'STRING')  ,
		('aadhar', 'STRING')  ,
		('problemSubmissionTime', 'TIMESTAMP') ,
		('hintMode', 'STRING')  ,
		('currentSeekTime', 'FLOAT') ,
		('queryText', 'STRING') ,
